...
import io.learnstuff.security.services.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (StringUtils.isNotEmpty(userEmail)
            ...
            if (userDetails != null) {
                Optional<UserEntity> user = this.userService.getUserByEmail(userEmail);
                user.ifPresent(userEntity -> request.setAttribute("identifier", userEntity.getId()));
            }
